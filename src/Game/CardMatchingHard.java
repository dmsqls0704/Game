...
public class CardMatchingHard extends JPanel {
     ...
     */
    public CardMatchingHard(CardLayout layout, JPanel panel, MainPage mainPage, LoginScreen loginscreen) {
        ...
        level3timer.addfinishPanel(cardLayout, panel, mainPage,loginscreen,score.getScore());
        ...
        for (int i = 0; i < 24; i++) {
            String imagePath = "src/hard/hard" + (i + 1) + ".jpg";
    ...
    private void addpausePanel(CardLayout layout, JPanel panel, MainPage mainPage) {
        ...
        PausePage pausePanel = new PausePage(layout, panel, mainPage,level3timer.getThisTimer(),"hardPanel");
